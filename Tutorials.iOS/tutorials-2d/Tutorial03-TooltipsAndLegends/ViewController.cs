...
namespace Tutorial03_TooltipsAndLegends
{
    public class ViewController : UIViewController
    {
        ...
        public override void ViewDidLoad()
        {
            ...
            var lineDataSeries = new XyDataSeries<int, double> { SeriesName = "Line Series " };
            var scatterDataSeries = new XyDataSeries<int, double> { SeriesName = "Scatter Series" };
            for (int i = 0; i < 200; i++)
            {
