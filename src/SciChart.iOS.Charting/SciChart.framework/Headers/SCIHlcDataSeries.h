 ...
 */
@protocol SCIHlcDataSeriesProtocol ///
 ...
 *
 */
-(void) appendRangeX:(SCIGenericType)x Y:(SCIGenericType)y High:(SCIGenericType)high Low:(SCIGenericType)low;
 ...
 */
-(void) updateRangeAt:(int)index X:(SCIGenericType)x Y:(SCIGenericType)y High:(SCIGenericType)high Low:(SCIGenericType)low;

/**
 * Updates an Y, High and Low range of points to the series at specified index
 */
-(void) updateRangeAt:(int)index Y:(SCIGenericType)y High:(SCIGenericType)high Low:(SCIGenericType)low;
 ...
 */
-(void) insertRangeAt:(int)index X:(SCIGenericType)x Y:(SCIGenericType)y High:(SCIGenericType)high Low:(SCIGenericType)low;
