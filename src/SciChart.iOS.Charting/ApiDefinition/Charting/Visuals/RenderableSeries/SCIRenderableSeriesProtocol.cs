...
{
    interface ISCIRenderableSeriesProtocol : INSObjectProtocol, ISCIDrawableProtocol { }

    // @protocol SCIRenderableSeriesProtocol <NSObject, SCIDrawableProtocol>
    [Protocol, Model]
    [BaseType(typeof(NSObject))]
    interface SCIRenderableSeriesProtocol : SCIDrawableProtocol
    {
