...
{
    [Example3DDefinition("Simple Uniform Impulse Series 3D Chart", description: "Create a simple Uniform Impulse Series 3D Chart", icon: ExampleIcon.Impulse)]
    class CreateUniformImpulseSeries3DChartFragment : ExampleBaseFragment
    {
        ...
        protected override void InitExample()
        {
            ...
            var renderableSeries3D = new ImpulseRenderableSeries3D()
            {
                ...
                Stroke = Color.DodgerBlue.ToArgb(),
