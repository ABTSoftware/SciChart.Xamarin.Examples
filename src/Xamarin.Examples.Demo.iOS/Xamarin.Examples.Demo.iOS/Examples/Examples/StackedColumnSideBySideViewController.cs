...
namespace Xamarin.Examples.Demo.iOS
{
    ...
    public class StackedColumnSideBySideViewController : SingleChartViewController<SCIChartSurface>
    {
        protected override void InitExample()
        {
            ...
            {
                AutoTicks = false,
                MajorDelta = new NSNumber(1).ToComparable(),
                MinorDelta = new NSNumber(0.5).ToComparable(),
                DrawMajorBands = true,
            ...
            using (Surface.SuspendUpdates())
            {
                ...
                Surface.ChartModifiers.Add(new SCILegendModifier { ShowCheckBoxes = false, Margins = new UIEdgeInsets(10, 10, 10, 10) });
