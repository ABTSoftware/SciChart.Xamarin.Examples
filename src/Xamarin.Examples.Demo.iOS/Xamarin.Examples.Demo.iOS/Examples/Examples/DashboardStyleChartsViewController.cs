...
namespace Xamarin.Examples.Demo.iOS
{
    ...
    public class DashboardStyleChartsViewController : CustomLayoutViewController<DashboardStyleChartsLayout>
    {
        public SCIChartSurface Chart => Layout.ChartView;
        ...
        static class ChartTypeFactory
        {
            public static ChartTypeModel NewHorizontallyStackedColumns()
            {
                ...
                for (var i = 0; i < 5; i++)
                {
                    ...
                    var rSeries = new SCIStackedColumnRenderableSeries
                    {
                        ...
                        FillBrushStyle = new SCILinearGradientBrushStyle(DashboardDataHelper.Colors[i * 2 + 1], DashboardDataHelper.Colors[i * 2])
                    };
            ...
            {
                var seriesCollection = new SCIVerticallyStackedColumnsCollection { IsOneHundredPercent = isOneHundredPercent };
            ...
            {
                var seriesCollection = new SCIVerticallyStackedMountainsCollection { IsOneHundredPercent = isOneHundredPercent };
                ...
                for (var i = 0; i < 5; i++)
                {
                    ...
                    var rSeries = new SCIStackedMountainRenderableSeries
                    {
                        DataSeries = dataSeries,
                        StrokeStyle = new SCISolidPenStyle(DashboardDataHelper.Colors[i * 2], 2f),
                        AreaStyle = new SCILinearGradientBrushStyle(DashboardDataHelper.Colors[i * 2 + 1], DashboardDataHelper.Colors[i * 2])
                    };
