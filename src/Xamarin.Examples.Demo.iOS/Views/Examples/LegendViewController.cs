...
namespace Xamarin.Examples.Demo.iOS.Views.Examples
{
    ...
    public class LegendViewController : ExampleBaseViewController
    {
        ...
        protected override void InitExample()
        {
            ...
            {
                var animation = new SCIDrawLineRenderableSeriesAnimation(3, SCIAnimationCurve.EaseOut);
                ...
                var rs4 = new SCIFastLineRenderableSeries { DataSeries = ds4, IsVisible = false, StrokeStyle = new SCISolidPenStyle(0xFF1964FF, 2f) };
                rs4.AddAnimation(animation);

                Surface.RenderableSeries = new SCIRenderableSeriesCollection {rs1, rs2, rs2, rs4};
