...
namespace Xamarin.Examples.Demo.iOS.Views.Examples
{
    ...
    public class CreateRealtimeTickingStockChartsViewController : ExampleBaseViewController
    {
        ...
        public override Type ExampleViewType => typeof(RealtimeTickingStockChartsLayout);

        public SCIChartSurface MainSurface => ((RealtimeTickingStockChartsLayout)View).MainSurfaceView;
        public SCIChartSurface OverviewSurface => ((RealtimeTickingStockChartsLayout)View).OverviewSurfaceView;
