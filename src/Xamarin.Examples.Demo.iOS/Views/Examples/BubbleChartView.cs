...
namespace Xamarin.Examples.Demo.iOS.Views.Examples
{
    ...
    public class BubbleChartView : ExampleBaseView<SingleChartViewLayout>
    {
        ...
        protected override void UpdateFrame()
        {
            ...
            Surface.RenderableSeriesAreaFill = new SCISolidBrushStyle(UIColor.Red);
        ...
        protected override void InitExampleInternal()
        {
            ...
            xAxis.Style.GridBandBrush = new SCISolidBrushStyle(UIColor.Clear);
            var yAxis = new SCINumericAxis { GrowBy = new SCIDoubleRange(0, 0.1) };
            yAxis.Style.GridBandBrush = new SCISolidBrushStyle(UIColor.Clear);
