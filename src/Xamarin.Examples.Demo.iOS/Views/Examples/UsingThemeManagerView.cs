...
namespace Xamarin.Examples.Demo.iOS.Views.Examples
{
    ...
    public class UsingThemeManagerView : ExampleBaseView<UsingThemeManagerLayout>
    {
        ...
        private void InitializeUIHandlers()
        {
            ExampleViewLayout.SelectThemeButton.TouchUpInside += (sender, args) =>
            {
                ...
                foreach (var themeName in ThemeNames)
                {
                    ...
                    {
                        ApplyTheme(ThemeKeys[Array.IndexOf(ThemeNames, themeName)]);
                        ExampleViewLayout.SelectThemeButton.SetTitle(themeName, UIControlState.Normal);
                    });
        ...
        {
            SCIThemeManager.ApplyTheme(Surface, themeKey);
        }
    }
}