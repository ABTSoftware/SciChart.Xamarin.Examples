...
namespace Xamarin.Examples.Demo.iOS
{
    ...
    public class DashboardStyleChartsViewController : ExampleBaseViewController
    {
        public override Type ExampleViewType => typeof(DashboardStyleChartsLayout);

        public SCIChartSurface Chart => ((DashboardStyleChartsLayout)View).ChartView;
