...
namespace SciChart.iOS.Charting
{
    ...
    {
        // - (id)initWithAxisCollection:(NSArray<id <SCIAxis2DProtocol>> *)axes Parent:(SCIChartSurface *)parent IsXAxisCollection:(BOOL)isXcollection;
        ...
        void SetAxis(ISCIAxis2DProtocol axis, int index);
    }
}