...
namespace SciChart.iOS.Charting
{
    ...
    // @protocol SCIChartSurfaceProtocol <NSObject, SCIInvalidatableElementProtocol, SCIThemeableProtocol, SCISuspendableProtocol>
    [Protocol, Model]
    [BaseType(typeof(NSObject))]
    interface SCIChartSurfaceProtocol : SCIInvalidatableElementProtocol, SCIThemeableProtocol, SCISuspendableProtocol
    {
        ...
        // @required @property (nonatomic, strong) SCIGestureController * _Nonnull gestureController;
        [Abstract]
