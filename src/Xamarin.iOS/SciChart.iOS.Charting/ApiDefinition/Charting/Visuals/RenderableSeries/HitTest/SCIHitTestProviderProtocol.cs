...
namespace SciChart.iOS.Charting
{
    ...
    interface SCIHitTestProviderProtocol
    {
        ...
        SCIHitTestInfo HitTestAtX(double x, double y, double radius, ISCIRenderPassDataProtocol data);
        ...
        SCIHitTestInfo HitTestVerticalAtX(double x, double y, double radius, ISCIRenderPassDataProtocol data);
        ...
        SCIHitTestInfo HitTestAtX(double x, double y, double radius, ISCIRenderPassDataProtocol data, SCIHitTestMode mode);
        ...
        SCIHitTestInfo HitTestPointModeAtX(double x, double y, double radius, ISCIRenderPassDataProtocol data);
        ...
        SCIHitTestInfo HitTestInterpolateModeAtX(double x, double y, double radius, ISCIRenderPassDataProtocol data);
        ...
        SCIHitTestInfo HitTestVerticalModeAtX(double x, double y, double radius, ISCIRenderPassDataProtocol data);
        ...
        SCIHitTestInfo HitTestVerticalInterpolateModeAtX(double x, double y, double radius, ISCIRenderPassDataProtocol data);
    }
}