...
namespace SciChart.Core.Utility
{
    public static class DateTimeExtensions
    {
        ...
        {
            return (dateTime.ToUniversalTime().Ticks - JavaDateTicks)/TimeSpan.TicksPerMillisecond;
        }
        ...
        {
            return new DateTime(unixTime*TimeSpan.TicksPerMillisecond + JavaDateTicks, DateTimeKind.Utc);
        }
